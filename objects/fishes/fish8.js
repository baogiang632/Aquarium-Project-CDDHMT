...
export class Fish {
  constructor() {
    ...
    mtlLoader.load('../../models/fish/fish8/13013_Red_Head_Solon_Fairy_Wrasse_v1_l3.mtl', function (materials) {
        materials.preload();
        new OBJLoader().setMaterials(materials).load('../../models/fish/fish8/13013_Red_Head_Solon_Fairy_Wrasse_v1_l3.obj', object => {
          object.rotation.set(
            fishRotation[0],
            fishRotation[1],
            fishRotation[2]
