...
export class Fish {
  constructor() {
    ...
    let fishRotation = [Math.PI * -0.5, 0, 0];
    ...
    mtlLoader.load('../../models/fish/fish10/13016_Yellowtai_ Damselfish_v2_l3.mtl', function (materials) {
        materials.preload();
        new OBJLoader().setMaterials(materials).load('../../models/fish/fish10/13016_Yellowtai_ Damselfish_v2_l3.obj', object => {
          object.rotation.set(
            fishRotation[0],
            fishRotation[1],
            fishRotation[2]
