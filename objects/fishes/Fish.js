...
export class Fish {
  constructor() {
    ...
    this.bodyFish.castShadow = true; // this line enables the body to cast shadows
    this.bodyFish.receiveShadow = true; // this line enables the body to receive shadows
    ...
    this.tailFish.castShadow = true; // this line enables the tail to cast shadows
    this.tailFish.receiveShadow = true;
